...
pub struct PostSessionByIdPermissionsByPermissionIdParams {
    ...
    pub post_session_by_id_permissions_by_permission_id_request:
        Option<models::PostSessionByIdPermissionsByPermissionIdRequest>,
}
...
/// List all agents
pub async fn app_period_agents(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::Agent>, Error<AppPeriodAgentsError>> {
...
/// Get app info
pub async fn app_period_get(
    configuration: &configuration::Configuration,
) -> Result<models::App, Error<AppPeriodGetError>> {
...
/// Initialize the app
pub async fn app_period_init(
    configuration: &configuration::Configuration,
) -> Result<bool, Error<AppPeriodInitError>> {
...
pub async fn app_period_log(
    configuration: &configuration::Configuration,
    params: AppPeriodLogParams,
) -> Result<bool, Error<AppPeriodLogError>> {
...
pub async fn auth_period_set(
    configuration: &configuration::Configuration,
    params: AuthPeriodSetParams,
) -> Result<bool, Error<AuthPeriodSetError>> {
    let uri_str = format!(
        "{}/auth/{id}",
...
/// Get config info
pub async fn config_period_get(
    configuration: &configuration::Configuration,
) -> Result<models::Config, Error<ConfigPeriodGetError>> {
...
/// List all providers
pub async fn config_period_providers(
    configuration: &configuration::Configuration,
) -> Result<models::ConfigProviders200Response, Error<ConfigPeriodProvidersError>> {
...
/// Get events
pub async fn event_period_subscribe(
    configuration: &configuration::Configuration,
) -> Result<models::Event, Error<EventPeriodSubscribeError>> {
...
/// Read a file
pub async fn file_period_read(
    configuration: &configuration::Configuration,
    params: FilePeriodReadParams,
) -> Result<models::FileRead200Response, Error<FilePeriodReadError>> {
...
/// Get file status
pub async fn file_period_status(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::File>, Error<FilePeriodStatusError>> {
...
/// Find files
pub async fn find_period_files(
    configuration: &configuration::Configuration,
    params: FindPeriodFilesParams,
) -> Result<Vec<String>, Error<FindPeriodFilesError>> {
...
pub async fn find_period_symbols(
    configuration: &configuration::Configuration,
    params: FindPeriodSymbolsParams,
) -> Result<Vec<models::Symbol>, Error<FindPeriodSymbolsError>> {
...
/// Find text in files
pub async fn find_period_text(
    configuration: &configuration::Configuration,
    params: FindPeriodTextParams,
) -> Result<Vec<models::FindText200ResponseInner>, Error<FindPeriodTextError>> {
...
pub async fn post_session_by_id_permissions_by_permission_id(
    configuration: &configuration::Configuration,
    params: PostSessionByIdPermissionsByPermissionIdParams,
) -> Result<bool, Error<PostSessionByIdPermissionsByPermissionIdError>> {
    let uri_str = format!(
        "{}/session/{id}/permissions/{permissionID}",
        configuration.base_path,
        id = crate::apis::urlencode(params.id),
        permissionID = crate::apis::urlencode(params.permission_id)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PostSessionByIdPermissionsByPermissionIdError> =
...
/// Abort a session
pub async fn session_period_abort(
    configuration: &configuration::Configuration,
    params: SessionPeriodAbortParams,
) -> Result<bool, Error<SessionPeriodAbortError>> {
    let uri_str = format!(
        "{}/session/{id}/abort",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
pub async fn session_period_chat(
    configuration: &configuration::Configuration,
    params: SessionPeriodChatParams,
) -> Result<models::AssistantMessage, Error<SessionPeriodChatError>> {
    let uri_str = format!(
        "{}/session/{id}/message",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
pub async fn session_period_children(
    configuration: &configuration::Configuration,
    params: SessionPeriodChildrenParams,
) -> Result<Vec<models::Session>, Error<SessionPeriodChildrenError>> {
    let uri_str = format!(
        "{}/session/{id}/children",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
pub async fn session_period_create(
    configuration: &configuration::Configuration,
    params: SessionPeriodCreateParams,
) -> Result<models::Session, Error<SessionPeriodCreateError>> {
...
pub async fn session_period_delete(
    configuration: &configuration::Configuration,
    params: SessionPeriodDeleteParams,
) -> Result<bool, Error<SessionPeriodDeleteError>> {
    let uri_str = format!(
        "{}/session/{id}",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
/// Get session
pub async fn session_period_get(
    configuration: &configuration::Configuration,
    params: SessionPeriodGetParams,
) -> Result<models::Session, Error<SessionPeriodGetError>> {
    let uri_str = format!(
        "{}/session/{id}",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
pub async fn session_period_init(
    configuration: &configuration::Configuration,
    params: SessionPeriodInitParams,
) -> Result<bool, Error<SessionPeriodInitError>> {
    let uri_str = format!(
        "{}/session/{id}/init",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
/// List all sessions
pub async fn session_period_list(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::Session>, Error<SessionPeriodListError>> {
    let uri_str = format!("{}/session", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn session_period_message(
    configuration: &configuration::Configuration,
    params: SessionPeriodMessageParams,
) -> Result<models::SessionMessages200ResponseInner, Error<SessionPeriodMessageError>> {
    let uri_str = format!(
        "{}/session/{id}/message/{messageID}",
        configuration.base_path,
        id = crate::apis::urlencode(params.id),
        messageID = crate::apis::urlencode(params.message_id)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn session_period_messages(
    configuration: &configuration::Configuration,
    params: SessionPeriodMessagesParams,
) -> Result<Vec<models::SessionMessages200ResponseInner>, Error<SessionPeriodMessagesError>> {
    let uri_str = format!(
        "{}/session/{id}/message",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
/// Revert a message
pub async fn session_period_revert(
    configuration: &configuration::Configuration,
    params: SessionPeriodRevertParams,
) -> Result<models::Session, Error<SessionPeriodRevertError>> {
    let uri_str = format!(
        "{}/session/{id}/revert",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
/// Share a session
pub async fn session_period_share(
    configuration: &configuration::Configuration,
    params: SessionPeriodShareParams,
) -> Result<models::Session, Error<SessionPeriodShareError>> {
    let uri_str = format!(
        "{}/session/{id}/share",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
/// Run a shell command
pub async fn session_period_shell(
    configuration: &configuration::Configuration,
    params: SessionPeriodShellParams,
) -> Result<models::AssistantMessage, Error<SessionPeriodShellError>> {
    let uri_str = format!(
        "{}/session/{id}/shell",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
pub async fn session_period_summarize(
    configuration: &configuration::Configuration,
    params: SessionPeriodSummarizeParams,
) -> Result<bool, Error<SessionPeriodSummarizeError>> {
    let uri_str = format!(
...
pub async fn session_period_unrevert(
    configuration: &configuration::Configuration,
    params: SessionPeriodUnrevertParams,
) -> Result<models::Session, Error<SessionPeriodUnrevertError>> {
    let uri_str = format!(
        "{}/session/{id}/unrevert",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
/// Unshare the session
pub async fn session_period_unshare(
    configuration: &configuration::Configuration,
    params: SessionPeriodUnshareParams,
) -> Result<models::Session, Error<SessionPeriodUnshareError>> {
    let uri_str = format!(
        "{}/session/{id}/share",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
pub async fn session_period_update(
    configuration: &configuration::Configuration,
    params: SessionPeriodUpdateParams,
) -> Result<models::Session, Error<SessionPeriodUpdateError>> {
    let uri_str = format!(
        "{}/session/{id}",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
pub async fn tui_period_append_prompt(
    configuration: &configuration::Configuration,
    params: TuiPeriodAppendPromptParams,
) -> Result<bool, Error<TuiPeriodAppendPromptError>> {
...
/// Clear the prompt
pub async fn tui_period_clear_prompt(
    configuration: &configuration::Configuration,
) -> Result<bool, Error<TuiPeriodClearPromptError>> {
...
pub async fn tui_period_execute_command(
    configuration: &configuration::Configuration,
    params: TuiPeriodExecuteCommandParams,
) -> Result<bool, Error<TuiPeriodExecuteCommandError>> {
...
pub async fn tui_period_open_help(
    configuration: &configuration::Configuration,
) -> Result<bool, Error<TuiPeriodOpenHelpError>> {
...
pub async fn tui_period_open_models(
    configuration: &configuration::Configuration,
) -> Result<bool, Error<TuiPeriodOpenModelsError>> {
...
pub async fn tui_period_open_sessions(
    configuration: &configuration::Configuration,
) -> Result<bool, Error<TuiPeriodOpenSessionsError>> {
...
pub async fn tui_period_open_themes(
    configuration: &configuration::Configuration,
) -> Result<bool, Error<TuiPeriodOpenThemesError>> {
...
pub async fn tui_period_show_toast(
    configuration: &configuration::Configuration,
    params: TuiPeriodShowToastParams,
) -> Result<bool, Error<TuiPeriodShowToastError>> {
...
/// Submit the prompt
pub async fn tui_period_submit_prompt(
    configuration: &configuration::Configuration,
) -> Result<bool, Error<TuiPeriodSubmitPromptError>> {
